...
var guess = function() {
	...
	$('<li class="below">'+theirGuess+'</li>').appendTo(".guessFBack ul");
	$('.guessFBack h4').css('color', 'blue').text("Too Low!");
    } else if (theirGuess > answer) {
	$('<li class="above">'+theirGuess+'</li>').appendTo(".guessFBack ul");
	$('.guessFBack h4').css('color', 'red').text("Too High!");
    } else {
	//for right answer
